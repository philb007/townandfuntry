...
using InspectorPlusVar = DragDropItemInspector.InspectorPlusVar;

[CanEditMultipleObjects]
[CustomEditor(typeof(DragDropItem))]
public class DragDropItemInspector : Editor {
	...
	void OnEnable ()
	{
        ...
        so = serializedObject;
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None,0,0,false,0,0,true,"GameObject","prefab","Prefab",InspectorPlusVar.VectorDrawType.None,false,false,0,new System.Boolean[]{false,false,false,false},new System.String[]{"","","",""},new System.Boolean[]{false,false,false,false},new System.Boolean[]{false,false,false,false},new System.Int32[]{0,0,0,0},new System.Boolean[]{false,false,false,false},new System.String[]{"","","",""},new System.String[]{"","","",""},new System.Boolean[]{false,false,false,false},0,"DragDropItem",new Vector3(0.5f,0.5f,0f),false,true,"Prefab object that will be instantiated on the DragDropSurface if it receives the OnDrop event.",true,false,0,0,false,70,"",false));	
