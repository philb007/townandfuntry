...
using InspectorPlusVar = ActiveAnimationInspector.InspectorPlusVar;

[CanEditMultipleObjects]
[CustomEditor(typeof(ActiveAnimation))]
public class ActiveAnimationInspector : Editor {
	...
	void OnEnable ()
	{
        ...
        so = serializedObject;
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None,0,0,false,0,0,true,"OnFinished","onFinished","On Finished",InspectorPlusVar.VectorDrawType.None,false,false,0,new System.Boolean[]{false,false,false,false},new System.String[]{"","","",""},new System.Boolean[]{false,false,false,false},new System.Boolean[]{false,false,false,false},new System.Int32[]{0,0,0,0},new System.Boolean[]{false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false},new System.String[]{"","","","","","","","","","","","","","","",""},new System.String[]{"","","","","","","","","","","","","","","",""},new System.Boolean[]{false,false,false,false},0,"ActiveAnimation",new Vector3(0.5f,0.5f,0f),false,true,"Delegate for subscriptions. Faster than using the 'eventReceiver' and allows for multiple receivers.",true,false,0,0,false,70,"",false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None,0,0,false,0,0,true,"GameObject","eventReceiver","Event Receiver",InspectorPlusVar.VectorDrawType.None,false,false,0,new System.Boolean[]{false,false,false,false},new System.String[]{"","","",""},new System.Boolean[]{false,false,false,false},new System.Boolean[]{false,false,false,false},new System.Int32[]{0,0,0,0},new System.Boolean[]{false,false,false,false},new System.String[]{"","","",""},new System.String[]{"","","",""},new System.Boolean[]{false,false,false,false},0,"ActiveAnimation",new Vector3(0.5f,0.5f,0f),false,true,"Game object on which to call the callback function.",true,false,0,0,false,70,"",false));
        vars.Add(new InspectorPlusVar(InspectorPlusVar.LimitType.None,0,0,false,0,0,true,"String","callWhenFinished","Call When Finished",InspectorPlusVar.VectorDrawType.None,false,false,0,new System.Boolean[]{false,false,false,false},new System.String[]{"","","",""},new System.Boolean[]{false,false,false,false},new System.Boolean[]{false,false,false,false},new System.Int32[]{0,0,0,0},new System.Boolean[]{false,false,false,false},new System.String[]{"","","",""},new System.String[]{"","","",""},new System.Boolean[]{false,false,false,false},0,"ActiveAnimation",new Vector3(0.5f,0.5f,0f),false,true,"Function to call when the animation finishes playing.",true,false,0,0,false,70,"",false));	
